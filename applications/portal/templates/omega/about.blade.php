        ...
        <div class="container-fluid" style="padding:0px">
                ...
                <div class="col-md-12  swatch-gray">
                    ...
                    <div class="col-md-8 not-condensed os-animation animated fadeInUp swatch-gray" style="-webkit-animation: 0s;padding-top:30px;padding-bottom:50px">
                        ...
                        <div style="padding-left:50px;padding-right:50px">
                            <p>Research Data Switchboard helps you find, access, and reuse data for research from over one hundred
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-10  ">
                    ...
                    <div class="col-md-6 text-center" style="padding-left:20px;padding-top:30px" >
                        ...
                        <div class="text-left">
                        <p>Research Data Switchboard caters specifically for researchers but also has broader relevance to others including policy makers, educators and business people.</p>
                        <p>Research Data Switchboard covers a broad spectrum of research fields - across sciences, social sciences, arts and humanities. Much of the data you can discover
            ...
            <div class="col-md-12  swatch-gray data-os-animation-delay">
                ...
                <div class="col-md-8 not-condensed os-animation animated fadeInUp swatch-gray data-os-animation-delay" style="-webkit-animation: 0s;padding-top:30px;padding-bottom:50px">
                    ...
                    <div style="padding-left:50px;padding-right:50px">
                        <p>A single search in Research Data Switchboard retrieves data resources across a wide range of subjects and providers, so that you can: </p>
                        <p>
