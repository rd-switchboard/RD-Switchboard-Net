					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-10 swatch-white" id="advbody">
							...
							<div ng-if="isAdvancedSearchActive('date_range')">
								...
								<div class="alert alert-info">Please note that adding this filter will restrict your search to only those activity records in Research Data Switchboard which have a start date recorded</div>
								...
								<div class="alert alert-info">Please note that adding this filter will restrict your search to only those activity records in Research Data Switchboard which have an end date recorded</div>
							</div>
