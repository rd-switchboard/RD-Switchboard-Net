...
<p>The Data Provider tab allows you to limit your search to records published to Research Data Switchboard by specific providers.The number of records available from providers will be displayed at the end of each provider literal E.g ‘Bond University (25)’.</p>
...
<p>The Access tab allows you to limit your search to records with specific access types. Data records in Research Data Switchboard fall into one of four access types:</p>
<dl>
