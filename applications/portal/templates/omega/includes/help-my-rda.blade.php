...
<br/>
<h3 id="my_rda_video">How to use MyRDA in Research Data Switchboard</h3>
<br/>
@if($useIFrame)
...
<p>Once logged into your MyRDA account searches can be saved and rerun across Research Data Switchboard sessions.
To save a search:</p>
<ol>
...
<p>Once a search has been saved to your account checking for new results across Research Data Switchboard sessions is a quick and easy process.</p>
...
<ul>
    ...
    <li>The number of new records added to Research Data Switchboard since the time of saving.
        <ul>
    ...
    <li>The number of records added to Research Data Switchboard since the user last checked for new results.
        <ul>
            <li>This number allows users to keep track of the number of new records across Research Data Switchboard sessions without the need to remember how many new records were added since the search was saved. This number is only updated when the user invokes a check for new results.</li>
        </ul>
    </li>
</ul>
