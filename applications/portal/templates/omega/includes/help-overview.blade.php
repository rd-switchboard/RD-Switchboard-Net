...
<ul style="list-style-type: none;">
    <li><a href="#intro_video">Introduction to Research Data Switchboard</a></li>
    <li><a href="#search_video_ov">How to search in Research Data Switchboard</a></li>
    <li><a href="#my_rda_video_ov">How to use MyRDA in Research Data Switchboard</a></li>

</ul>
<p>Welcome to Research Data Switchboard help. Watch the videos below to get yourself acquainted with site, or use the tabs displayed above to navigate to specific help sections.</p>
...
<br/>
<h3 id="intro_video">Introduction to Research Data Switchboard</h3>
<br/>
@if($useIFrame)
...
@endif
<br/><br/>
<h3 id="search_video_ov">How to search in Research Data Switchboard</h3>
<br/>
@if($useIFrame)
...
@endif
<br/><br/>
<h3 id="my_rda_video_ov">How to use MyRDA in Research Data Switchboard</h3>
<br/>
@if($useIFrame)
