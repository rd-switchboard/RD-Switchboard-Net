...
@if(is_dev())
    ...
    <!-- Graph Widget -->
    <script src="{{apps_url('assets/graph_widget/js/d3.js')}}"></script>
    <!-- <script src="{{apps_url('assets/graph_widget/js/d3.tip.js')}}"></script> -->
    <!-- <script src="{{apps_url('assets/graph_widget/js/graph_widget.js')}}"></script> -->
    <script src="{{asset_url('lib/d3/d3.min.js', 'core')}}"></script>
    <script src="{{asset_url('js/graph_widget.js', 'core')}}"></script>
@else
