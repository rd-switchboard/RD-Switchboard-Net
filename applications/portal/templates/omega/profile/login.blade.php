...
<div class="row hide" id="main">
    <div class="col-lg-6 col-lg-offset-3 col-xs-12 col-md-12">
        ...
        <div class="element-small-top">
            <p>By logging into Research Data Switchboard, you will have access to additional features including the ability to save records and searches, and contribute to the Research Data Switchboard community by adding tags (keywords) to records.</p>
            <p><small>Research Data Switchboard. <a href="{{ base_url('home/privacy') }}">Privacy Policy</a></small></p>
        </div>
    </div>
</div>
