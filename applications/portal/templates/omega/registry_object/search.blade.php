...
<div class="panel panel-primary element-no-top element-small-bottom" data-os-animation="fadeInUp">
    ...
    <div class="panel-body swatch-white" ng-if="result.response.docs.length < 1" ng-cloak>
        ...
        <p>Some suggestion for searching in Research Data Switchboard</p>
        <ul>
...
<div class="panel panel-primary panel-green element-no-top element-no-bottom os-animation animated fadeInUp" data-os-animation="fadeInUp" data-os-animation-delay="0.2s" style="-webkit-animation: 0.2s;">
    ...
    <div class="panel-body swatch-white" ng-show="showFacet('commencement_from')">
        <h4>Commencement date <i class="fa fa-info" tip="Please note that adding this filter will restrict your search to only those project and grants in Research Data Switchboard which have a start date recorded."></i></h4>
    ...
    <div class="panel-body swatch-white" ng-show="showFacet('completion_to')">
        <h4>Completion date <i class="fa fa-info" tip="Please note that adding this filter will restrict your search to only those projects and grants in Research Data Switchboard which have an end date recorded."></i></h4>
    ...
    <div class="panel-body swatch-white" ng-show="showFacet('temporal')">
        <h4>Time Period <i class="fa fa-info" tip="Please note that adding a time period filter to your search will restrict your search to only those records in Research Data Switchboard which contain temporal information."></i></h4>
