		   ...
		   <div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div id="grant-query-div" >
						...
						<p>The record for this grant is not available in Research Data Switchboard yet;<br/>
						however, we can send you a notification once the grant record has been published in Research Data Switchboard. To receive the notification, please complete the below form:</p>
						<header class="text-center element-normal-top element-no-bottom not-condensed os-animation animated fadeInUp" data-os-animation="fadeInUp" data-os-animation-delay="0s" style="-webkit-animation: 0s;">
